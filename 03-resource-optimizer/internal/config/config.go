// Package config loads resource-optimizer settings from the environment.
package config
...
func Load() Config {
	return Config{
		Namespace:        getEnv("TARGET_NAMESPACE", "resource-optimizer-demo"),
		...
		DriftThreshold:   getEnvFloat("DRIFT_THRESHOLD", 0.3),
